...
import { authClient } from "../services/api-client"; // إضافة هذا السطر
...
const RegisterPage = () => {
    ...
    const onSubmit = async (data) => {
        try {
            // إزالة استدعاء registerUser مباشرة وإضافة تأخير
            await authClient.get("/sanctum/csrf-cookie");
            
            // انتظار 2 ثانية
            await new Promise(resolve => setTimeout(resolve, 2000));
            
            // ثم إرسال بيانات التسجيل
            ...
            toast.error(err?.response?.data?.message || "فشل إنشاء الحساب. الرجاء المحاولة مرة أخرى.");
        }
    };
                ...
                <div className="hidden lg:block lg:w-1/2 relative">
                    ...
                    <div className="absolute inset-0 bg-gradient-to-t from-blue-900/70 to-transparent flex flex-col justify-end p-8 text-white">
                        ...
                        <motion.p {...fadeIn} transition={{ delay: 0.4 }}>
                            قم بإنشاء حساب للاستفادة من جميع الخدمات
                        </motion.p>
                    </div>
                </div>
