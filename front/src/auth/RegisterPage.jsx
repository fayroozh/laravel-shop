            ...
            <div className="flex w-full max-w-5xl mx-auto rounded-xl shadow-lg overflow-hidden z-10">
                ...
                <motion.div className="w-full lg:w-1/2 bg-white p-8 md:p-12" {...slideIn(20)}>
                    ...
                    <form onSubmit={handleSubmit(onSubmit)} className="space-y-6">
                        ...
                        <InputField label="Name" type="text" placeholder="Enter your name" icon={<UserIcon />} register={register} errors={errors} name="name" />
                        <InputField label="Email" type="email" placeholder="Enter your email" icon={<EmailIcon />} register={register} errors={errors} name="email" />
                        <InputField label="Password" type="password" placeholder="••••••••" icon={<LockIcon />} register={register} errors={errors} name="password" />
                        <InputField label="Confirm Password" type="password" placeholder="••••••••" icon={<LockIcon />} register={register} errors={errors} name="password_confirmation" />
